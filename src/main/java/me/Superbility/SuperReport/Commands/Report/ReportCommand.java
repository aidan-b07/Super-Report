package me.Superbility.SuperReport.Commands.Report;

import me.Superbility.SuperReport.Configs.MessagesConfig;
import me.Superbility.SuperReport.DiscordBot;
import me.Superbility.SuperReport.GetValues;
import me.Superbility.SuperReport.Main;
import me.Superbility.SuperReport.Utils.ErrorCodes;
import me.Superbility.SuperReport.Utils.GenerateUUID;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("report")) { //Checks command name
            if (sender instanceof Player) { //Checks if sender is player
                ...
                if (player.hasPermission("superreport.report")) { //Checks if player has permission
                    ...
                    player.sendMessage(values.getNoPermission()); //Sends no permission message
                    return true;
                }
            }
        }
