package me.Superbility.SuperReport.Configs;
...
public class MessagesConfig {
    ...
    private void addDefaults() {
        reportMenuCfg.set("NoPermission", "&1&l[&9&lSuper-Report&1&l] &c- You can't do that!");
    ...
    private void setValues() {
        GetValues.setNoPermission(ChatColor.translateAlternateColorCodes('&',
                reportMenuCfg.getString("NoPermission")));
